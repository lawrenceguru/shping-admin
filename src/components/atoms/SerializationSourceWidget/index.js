...
import SerializationSourceWidget from './SerializationSourceWidget'
...
export default connect(mapStateToProps, { settingsGetCountries, settingsGetLanguages })(SerializationSourceWidget)
