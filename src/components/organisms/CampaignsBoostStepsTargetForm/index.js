...
const CampaignsRemindersTarget = ({ values: initialValues, form, setAntdData, setAntdComplete }) => {
...
CampaignsRemindersTarget.propTypes = {
...
CampaignsRemindersTarget.defaultProps = {
  values: {}
}

export default CampaignsRemindersTarget
