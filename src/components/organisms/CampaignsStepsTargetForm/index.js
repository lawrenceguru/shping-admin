...
const CampaignsStepsTargetForm = ({ values: initialValues, form, setAntdData, setAntdComplete }) => {
...
CampaignsStepsTargetForm.propTypes = {
...
CampaignsStepsTargetForm.defaultProps = {
  values: {}
}

export default CampaignsStepsTargetForm
