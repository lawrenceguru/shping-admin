...
export function* getIndexInfo() {
  try {
    ...
    if (data) {
      ...
      const { table, fields, default_fields } = data.find(index_schema => index_schema.type === 'slgtin')
      ...
      yield put(
        actions.indexFieldsSerializationGetIndexInfoSuccess({
          tableName: table,
    ...
    yield put(actions.indexFieldsSerializationGetIndexInfoFail(error))
  }
}
...
export function* postIndexInfo({ payload }) {
  try {
    ...
    if (data) {
      ...
      yield put(
        actions.indexFieldsSerializationPostIndexInfoSuccess({
          tableName: table,
          indexFields: fields
        })
      )
    ...
    yield put(actions.indexFieldsSerializationPostIndexInfoFail(error))
